# seekhao — Project Notes (internal)

## User requirements (from messages)
- App name: **seekhao** (replaces old "voice-interview-agent" build)
...
- New webdev project: /home/ubuntu/seekhao (web-static scaffold, React 19 + Tailwind 4 + wouter)
...
## Deliverables so far
- The current seekhao project is prepared for delivery to the private GitHub repository: https://github.com/ShaniOnGitHub/voice-interview-agent
